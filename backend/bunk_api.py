...
#     subject_importance = data.get('subject_importance', 0)
#     days_to_exam = data.get('days_to_exam', 0)

#     features = np.array([[attendance_percentage, num_classes, subject_importance, days_to_exam]])
...
#     # Map class importance and professor strictness if string
